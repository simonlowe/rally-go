...
// checks if the SubscriptionTag type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SubscriptionTag{}
...
func (o SubscriptionTag) MarshalJSON() ([]byte, error) {
...
func (o SubscriptionTag) ToMap() (map[string]interface{}, error) {
...
type NullableSubscriptionTag struct {
	value *SubscriptionTag
	isSet bool
}

func (v NullableSubscriptionTag) Get() *SubscriptionTag {
	return v.value
}

func (v *NullableSubscriptionTag) Set(val *SubscriptionTag) {
	v.value = val
	v.isSet = true
}

func (v NullableSubscriptionTag) IsSet() bool {
	return v.isSet
}

func (v *NullableSubscriptionTag) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSubscriptionTag(val *SubscriptionTag) *NullableSubscriptionTag {
	return &NullableSubscriptionTag{value: val, isSet: true}
}

func (v NullableSubscriptionTag) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSubscriptionTag) UnmarshalJSON(src []byte) error {
	v.isSet = true
