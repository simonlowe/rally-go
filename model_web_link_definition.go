...
// checks if the WebLinkDefinition type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WebLinkDefinition{}
...
func (o WebLinkDefinition) ToMap() (map[string]interface{}, error) {
...
type NullableWebLinkDefinition struct {
	value *WebLinkDefinition
	isSet bool
}

func (v NullableWebLinkDefinition) Get() *WebLinkDefinition {
	return v.value
}

func (v *NullableWebLinkDefinition) Set(val *WebLinkDefinition) {
	v.value = val
	v.isSet = true
}

func (v NullableWebLinkDefinition) IsSet() bool {
	return v.isSet
}

func (v *NullableWebLinkDefinition) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWebLinkDefinition(val *WebLinkDefinition) *NullableWebLinkDefinition {
	return &NullableWebLinkDefinition{value: val, isSet: true}
}

func (v NullableWebLinkDefinition) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWebLinkDefinition) UnmarshalJSON(src []byte) error {
	v.isSet = true
