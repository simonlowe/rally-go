...
// checks if the UserProfileQuery200ResponseQueryResult type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UserProfileQuery200ResponseQueryResult{}

// UserProfileQuery200ResponseQueryResult struct for UserProfileQuery200ResponseQueryResult
type UserProfileQuery200ResponseQueryResult struct {
	StartIndex       *int64        `json:"StartIndex,omitempty"`
	PageSize         *int64        `json:"PageSize,omitempty"`
	TotalResultCount *int64        `json:"TotalResultCount,omitempty"`
	Results          []UserProfile `json:"Results,omitempty"`
...
func NewUserProfileQuery200ResponseQueryResult() *UserProfileQuery200ResponseQueryResult {
	this := UserProfileQuery200ResponseQueryResult{}
	return &this
}
...
// SetResults gets a reference to the given []UserProfile and assigns it to the Results field.
...
func (o UserProfileQuery200ResponseQueryResult) MarshalJSON() ([]byte, error) {
...
func (o UserProfileQuery200ResponseQueryResult) ToMap() (map[string]interface{}, error) {
...
type NullableUserProfileQuery200ResponseQueryResult struct {
	value *UserProfileQuery200ResponseQueryResult
	isSet bool
}

func (v NullableUserProfileQuery200ResponseQueryResult) Get() *UserProfileQuery200ResponseQueryResult {
	return v.value
}

func (v *NullableUserProfileQuery200ResponseQueryResult) Set(val *UserProfileQuery200ResponseQueryResult) {
	v.value = val
	v.isSet = true
}

func (v NullableUserProfileQuery200ResponseQueryResult) IsSet() bool {
	return v.isSet
}

func (v *NullableUserProfileQuery200ResponseQueryResult) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUserProfileQuery200ResponseQueryResult(val *UserProfileQuery200ResponseQueryResult) *NullableUserProfileQuery200ResponseQueryResult {
	return &NullableUserProfileQuery200ResponseQueryResult{value: val, isSet: true}
}

func (v NullableUserProfileQuery200ResponseQueryResult) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUserProfileQuery200ResponseQueryResult) UnmarshalJSON(src []byte) error {
	v.isSet = true
