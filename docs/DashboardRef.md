...
`func NewDashboardRef(ref string, ) *DashboardRef`
...
`func (o *DashboardRef) GetRef() string`

GetRef returns the Ref field if non-nil, zero value otherwise.

### GetRefOk

`func (o *DashboardRef) GetRefOk() (*string, bool)`
...
`func (o *DashboardRef) SetRef(v string)`
