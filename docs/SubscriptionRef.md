...
`func NewSubscriptionRef(ref string, ) *SubscriptionRef`
...
`func (o *SubscriptionRef) GetRef() string`

GetRef returns the Ref field if non-nil, zero value otherwise.

### GetRefOk

`func (o *SubscriptionRef) GetRefOk() (*string, bool)`
...
`func (o *SubscriptionRef) SetRef(v string)`
