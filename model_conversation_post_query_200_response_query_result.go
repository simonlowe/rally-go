...
// checks if the ConversationPostQuery200ResponseQueryResult type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ConversationPostQuery200ResponseQueryResult{}
...
func NewConversationPostQuery200ResponseQueryResult() *ConversationPostQuery200ResponseQueryResult {
	this := ConversationPostQuery200ResponseQueryResult{}
	return &this
}
...
// SetResults gets a reference to the given []ConversationPost and assigns it to the Results field.
...
func (o ConversationPostQuery200ResponseQueryResult) ToMap() (map[string]interface{}, error) {
...
type NullableConversationPostQuery200ResponseQueryResult struct {
	value *ConversationPostQuery200ResponseQueryResult
	isSet bool
}

func (v NullableConversationPostQuery200ResponseQueryResult) Get() *ConversationPostQuery200ResponseQueryResult {
	return v.value
}

func (v *NullableConversationPostQuery200ResponseQueryResult) Set(val *ConversationPostQuery200ResponseQueryResult) {
	v.value = val
	v.isSet = true
}

func (v NullableConversationPostQuery200ResponseQueryResult) IsSet() bool {
	return v.isSet
}

func (v *NullableConversationPostQuery200ResponseQueryResult) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableConversationPostQuery200ResponseQueryResult(val *ConversationPostQuery200ResponseQueryResult) *NullableConversationPostQuery200ResponseQueryResult {
	return &NullableConversationPostQuery200ResponseQueryResult{value: val, isSet: true}
}

func (v NullableConversationPostQuery200ResponseQueryResult) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableConversationPostQuery200ResponseQueryResult) UnmarshalJSON(src []byte) error {
	v.isSet = true
