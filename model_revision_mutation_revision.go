...
// checks if the RevisionMutationRevision type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RevisionMutationRevision{}
...
func (o RevisionMutationRevision) ToMap() (map[string]interface{}, error) {
...
type NullableRevisionMutationRevision struct {
	value *RevisionMutationRevision
	isSet bool
}

func (v NullableRevisionMutationRevision) Get() *RevisionMutationRevision {
	return v.value
}

func (v *NullableRevisionMutationRevision) Set(val *RevisionMutationRevision) {
	v.value = val
	v.isSet = true
}

func (v NullableRevisionMutationRevision) IsSet() bool {
	return v.isSet
}

func (v *NullableRevisionMutationRevision) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRevisionMutationRevision(val *RevisionMutationRevision) *NullableRevisionMutationRevision {
	return &NullableRevisionMutationRevision{value: val, isSet: true}
}

func (v NullableRevisionMutationRevision) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRevisionMutationRevision) UnmarshalJSON(src []byte) error {
	v.isSet = true
