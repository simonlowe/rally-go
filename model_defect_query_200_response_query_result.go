...
// checks if the DefectQuery200ResponseQueryResult type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DefectQuery200ResponseQueryResult{}

// DefectQuery200ResponseQueryResult struct for DefectQuery200ResponseQueryResult
type DefectQuery200ResponseQueryResult struct {
	StartIndex *int64 `json:"StartIndex,omitempty"`
	PageSize *int64 `json:"PageSize,omitempty"`
	TotalResultCount *int64 `json:"TotalResultCount,omitempty"`
	Results []Defect `json:"Results,omitempty"`
...
func NewDefectQuery200ResponseQueryResult() *DefectQuery200ResponseQueryResult {
	this := DefectQuery200ResponseQueryResult{}
	return &this
}
...
// SetResults gets a reference to the given []Defect and assigns it to the Results field.
...
func (o DefectQuery200ResponseQueryResult) MarshalJSON() ([]byte, error) {
...
func (o DefectQuery200ResponseQueryResult) ToMap() (map[string]interface{}, error) {
...
type NullableDefectQuery200ResponseQueryResult struct {
	value *DefectQuery200ResponseQueryResult
	isSet bool
}

func (v NullableDefectQuery200ResponseQueryResult) Get() *DefectQuery200ResponseQueryResult {
	return v.value
}

func (v *NullableDefectQuery200ResponseQueryResult) Set(val *DefectQuery200ResponseQueryResult) {
	v.value = val
	v.isSet = true
}

func (v NullableDefectQuery200ResponseQueryResult) IsSet() bool {
	return v.isSet
}

func (v *NullableDefectQuery200ResponseQueryResult) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDefectQuery200ResponseQueryResult(val *DefectQuery200ResponseQueryResult) *NullableDefectQuery200ResponseQueryResult {
	return &NullableDefectQuery200ResponseQueryResult{value: val, isSet: true}
}

func (v NullableDefectQuery200ResponseQueryResult) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDefectQuery200ResponseQueryResult) UnmarshalJSON(src []byte) error {
	v.isSet = true
