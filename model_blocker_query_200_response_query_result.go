...
// checks if the BlockerQuery200ResponseQueryResult type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BlockerQuery200ResponseQueryResult{}

// BlockerQuery200ResponseQueryResult struct for BlockerQuery200ResponseQueryResult
type BlockerQuery200ResponseQueryResult struct {
	StartIndex       *int64    `json:"StartIndex,omitempty"`
	PageSize         *int64    `json:"PageSize,omitempty"`
	TotalResultCount *int64    `json:"TotalResultCount,omitempty"`
	Results          []Blocker `json:"Results,omitempty"`
...
func NewBlockerQuery200ResponseQueryResult() *BlockerQuery200ResponseQueryResult {
	this := BlockerQuery200ResponseQueryResult{}
	return &this
}
...
// SetResults gets a reference to the given []Blocker and assigns it to the Results field.
...
func (o BlockerQuery200ResponseQueryResult) MarshalJSON() ([]byte, error) {
...
func (o BlockerQuery200ResponseQueryResult) ToMap() (map[string]interface{}, error) {
...
type NullableBlockerQuery200ResponseQueryResult struct {
	value *BlockerQuery200ResponseQueryResult
	isSet bool
}

func (v NullableBlockerQuery200ResponseQueryResult) Get() *BlockerQuery200ResponseQueryResult {
	return v.value
}

func (v *NullableBlockerQuery200ResponseQueryResult) Set(val *BlockerQuery200ResponseQueryResult) {
	v.value = val
	v.isSet = true
}

func (v NullableBlockerQuery200ResponseQueryResult) IsSet() bool {
	return v.isSet
}

func (v *NullableBlockerQuery200ResponseQueryResult) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBlockerQuery200ResponseQueryResult(val *BlockerQuery200ResponseQueryResult) *NullableBlockerQuery200ResponseQueryResult {
	return &NullableBlockerQuery200ResponseQueryResult{value: val, isSet: true}
}

func (v NullableBlockerQuery200ResponseQueryResult) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBlockerQuery200ResponseQueryResult) UnmarshalJSON(src []byte) error {
	v.isSet = true
