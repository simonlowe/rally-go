...
// checks if the PanelMutationPanel type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PanelMutationPanel{}
...
func (o PanelMutationPanel) ToMap() (map[string]interface{}, error) {
...
type NullablePanelMutationPanel struct {
	value *PanelMutationPanel
	isSet bool
}

func (v NullablePanelMutationPanel) Get() *PanelMutationPanel {
	return v.value
}

func (v *NullablePanelMutationPanel) Set(val *PanelMutationPanel) {
	v.value = val
	v.isSet = true
}

func (v NullablePanelMutationPanel) IsSet() bool {
	return v.isSet
}

func (v *NullablePanelMutationPanel) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePanelMutationPanel(val *PanelMutationPanel) *NullablePanelMutationPanel {
	return &NullablePanelMutationPanel{value: val, isSet: true}
}

func (v NullablePanelMutationPanel) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePanelMutationPanel) UnmarshalJSON(src []byte) error {
	v.isSet = true
