...
// checks if the TestCaseQuery200ResponseQueryResult type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TestCaseQuery200ResponseQueryResult{}

// TestCaseQuery200ResponseQueryResult struct for TestCaseQuery200ResponseQueryResult
type TestCaseQuery200ResponseQueryResult struct {
	StartIndex *int64 `json:"StartIndex,omitempty"`
	PageSize *int64 `json:"PageSize,omitempty"`
	TotalResultCount *int64 `json:"TotalResultCount,omitempty"`
	Results []TestCase `json:"Results,omitempty"`
...
func NewTestCaseQuery200ResponseQueryResult() *TestCaseQuery200ResponseQueryResult {
	this := TestCaseQuery200ResponseQueryResult{}
	return &this
}
...
// SetResults gets a reference to the given []TestCase and assigns it to the Results field.
...
func (o TestCaseQuery200ResponseQueryResult) MarshalJSON() ([]byte, error) {
...
func (o TestCaseQuery200ResponseQueryResult) ToMap() (map[string]interface{}, error) {
...
type NullableTestCaseQuery200ResponseQueryResult struct {
	value *TestCaseQuery200ResponseQueryResult
	isSet bool
}

func (v NullableTestCaseQuery200ResponseQueryResult) Get() *TestCaseQuery200ResponseQueryResult {
	return v.value
}

func (v *NullableTestCaseQuery200ResponseQueryResult) Set(val *TestCaseQuery200ResponseQueryResult) {
	v.value = val
	v.isSet = true
}

func (v NullableTestCaseQuery200ResponseQueryResult) IsSet() bool {
	return v.isSet
}

func (v *NullableTestCaseQuery200ResponseQueryResult) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTestCaseQuery200ResponseQueryResult(val *TestCaseQuery200ResponseQueryResult) *NullableTestCaseQuery200ResponseQueryResult {
	return &NullableTestCaseQuery200ResponseQueryResult{value: val, isSet: true}
}

func (v NullableTestCaseQuery200ResponseQueryResult) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTestCaseQuery200ResponseQueryResult) UnmarshalJSON(src []byte) error {
	v.isSet = true
