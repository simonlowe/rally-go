...
// checks if the TestCaseResultQuery200ResponseQueryResult type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TestCaseResultQuery200ResponseQueryResult{}
...
func NewTestCaseResultQuery200ResponseQueryResult() *TestCaseResultQuery200ResponseQueryResult {
	this := TestCaseResultQuery200ResponseQueryResult{}
	return &this
}
...
func (o TestCaseResultQuery200ResponseQueryResult) ToMap() (map[string]interface{}, error) {
...
type NullableTestCaseResultQuery200ResponseQueryResult struct {
	value *TestCaseResultQuery200ResponseQueryResult
	isSet bool
}

func (v NullableTestCaseResultQuery200ResponseQueryResult) Get() *TestCaseResultQuery200ResponseQueryResult {
	return v.value
}

func (v *NullableTestCaseResultQuery200ResponseQueryResult) Set(val *TestCaseResultQuery200ResponseQueryResult) {
	v.value = val
	v.isSet = true
}

func (v NullableTestCaseResultQuery200ResponseQueryResult) IsSet() bool {
	return v.isSet
}

func (v *NullableTestCaseResultQuery200ResponseQueryResult) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTestCaseResultQuery200ResponseQueryResult(val *TestCaseResultQuery200ResponseQueryResult) *NullableTestCaseResultQuery200ResponseQueryResult {
	return &NullableTestCaseResultQuery200ResponseQueryResult{value: val, isSet: true}
}

func (v NullableTestCaseResultQuery200ResponseQueryResult) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTestCaseResultQuery200ResponseQueryResult) UnmarshalJSON(src []byte) error {
	v.isSet = true
