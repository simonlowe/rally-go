...
// checks if the ProjectQuery200ResponseQueryResult type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ProjectQuery200ResponseQueryResult{}

// ProjectQuery200ResponseQueryResult struct for ProjectQuery200ResponseQueryResult
type ProjectQuery200ResponseQueryResult struct {
...
func NewProjectQuery200ResponseQueryResult() *ProjectQuery200ResponseQueryResult {
	this := ProjectQuery200ResponseQueryResult{}
	return &this
}
...
func (o ProjectQuery200ResponseQueryResult) MarshalJSON() ([]byte, error) {
...
func (o ProjectQuery200ResponseQueryResult) ToMap() (map[string]interface{}, error) {
...
type NullableProjectQuery200ResponseQueryResult struct {
	value *ProjectQuery200ResponseQueryResult
	isSet bool
}

func (v NullableProjectQuery200ResponseQueryResult) Get() *ProjectQuery200ResponseQueryResult {
	return v.value
}

func (v *NullableProjectQuery200ResponseQueryResult) Set(val *ProjectQuery200ResponseQueryResult) {
	v.value = val
	v.isSet = true
}

func (v NullableProjectQuery200ResponseQueryResult) IsSet() bool {
	return v.isSet
}

func (v *NullableProjectQuery200ResponseQueryResult) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableProjectQuery200ResponseQueryResult(val *ProjectQuery200ResponseQueryResult) *NullableProjectQuery200ResponseQueryResult {
	return &NullableProjectQuery200ResponseQueryResult{value: val, isSet: true}
}

func (v NullableProjectQuery200ResponseQueryResult) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableProjectQuery200ResponseQueryResult) UnmarshalJSON(src []byte) error {
	v.isSet = true
