...
// checks if the FlowStateQuery200ResponseQueryResult type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FlowStateQuery200ResponseQueryResult{}

// FlowStateQuery200ResponseQueryResult struct for FlowStateQuery200ResponseQueryResult
type FlowStateQuery200ResponseQueryResult struct {
	StartIndex       *int64      `json:"StartIndex,omitempty"`
	PageSize         *int64      `json:"PageSize,omitempty"`
	TotalResultCount *int64      `json:"TotalResultCount,omitempty"`
	Results          []FlowState `json:"Results,omitempty"`
...
func NewFlowStateQuery200ResponseQueryResult() *FlowStateQuery200ResponseQueryResult {
	this := FlowStateQuery200ResponseQueryResult{}
	return &this
}
...
// SetResults gets a reference to the given []FlowState and assigns it to the Results field.
...
func (o FlowStateQuery200ResponseQueryResult) MarshalJSON() ([]byte, error) {
...
func (o FlowStateQuery200ResponseQueryResult) ToMap() (map[string]interface{}, error) {
...
type NullableFlowStateQuery200ResponseQueryResult struct {
	value *FlowStateQuery200ResponseQueryResult
	isSet bool
}

func (v NullableFlowStateQuery200ResponseQueryResult) Get() *FlowStateQuery200ResponseQueryResult {
	return v.value
}

func (v *NullableFlowStateQuery200ResponseQueryResult) Set(val *FlowStateQuery200ResponseQueryResult) {
	v.value = val
	v.isSet = true
}

func (v NullableFlowStateQuery200ResponseQueryResult) IsSet() bool {
	return v.isSet
}

func (v *NullableFlowStateQuery200ResponseQueryResult) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFlowStateQuery200ResponseQueryResult(val *FlowStateQuery200ResponseQueryResult) *NullableFlowStateQuery200ResponseQueryResult {
	return &NullableFlowStateQuery200ResponseQueryResult{value: val, isSet: true}
}

func (v NullableFlowStateQuery200ResponseQueryResult) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFlowStateQuery200ResponseQueryResult) UnmarshalJSON(src []byte) error {
	v.isSet = true
