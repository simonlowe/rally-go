...
// checks if the KeyResultQuery200ResponseQueryResult type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &KeyResultQuery200ResponseQueryResult{}

// KeyResultQuery200ResponseQueryResult struct for KeyResultQuery200ResponseQueryResult
type KeyResultQuery200ResponseQueryResult struct {
...
func NewKeyResultQuery200ResponseQueryResult() *KeyResultQuery200ResponseQueryResult {
	this := KeyResultQuery200ResponseQueryResult{}
	return &this
}
...
// SetResults gets a reference to the given []KeyResult and assigns it to the Results field.
...
func (o KeyResultQuery200ResponseQueryResult) MarshalJSON() ([]byte, error) {
...
func (o KeyResultQuery200ResponseQueryResult) ToMap() (map[string]interface{}, error) {
...
type NullableKeyResultQuery200ResponseQueryResult struct {
	value *KeyResultQuery200ResponseQueryResult
	isSet bool
}

func (v NullableKeyResultQuery200ResponseQueryResult) Get() *KeyResultQuery200ResponseQueryResult {
	return v.value
}

func (v *NullableKeyResultQuery200ResponseQueryResult) Set(val *KeyResultQuery200ResponseQueryResult) {
	v.value = val
	v.isSet = true
}

func (v NullableKeyResultQuery200ResponseQueryResult) IsSet() bool {
	return v.isSet
}

func (v *NullableKeyResultQuery200ResponseQueryResult) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableKeyResultQuery200ResponseQueryResult(val *KeyResultQuery200ResponseQueryResult) *NullableKeyResultQuery200ResponseQueryResult {
	return &NullableKeyResultQuery200ResponseQueryResult{value: val, isSet: true}
}

func (v NullableKeyResultQuery200ResponseQueryResult) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableKeyResultQuery200ResponseQueryResult) UnmarshalJSON(src []byte) error {
	v.isSet = true
