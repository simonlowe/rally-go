...
// checks if the BuildQuery200ResponseQueryResult type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BuildQuery200ResponseQueryResult{}

// BuildQuery200ResponseQueryResult struct for BuildQuery200ResponseQueryResult
type BuildQuery200ResponseQueryResult struct {
	StartIndex       *int64   `json:"StartIndex,omitempty"`
	PageSize         *int64   `json:"PageSize,omitempty"`
	TotalResultCount *int64   `json:"TotalResultCount,omitempty"`
	Results          []Build  `json:"Results,omitempty"`
...
func NewBuildQuery200ResponseQueryResult() *BuildQuery200ResponseQueryResult {
	this := BuildQuery200ResponseQueryResult{}
	return &this
}
...
// SetResults gets a reference to the given []Build and assigns it to the Results field.
...
func (o BuildQuery200ResponseQueryResult) MarshalJSON() ([]byte, error) {
...
func (o BuildQuery200ResponseQueryResult) ToMap() (map[string]interface{}, error) {
...
type NullableBuildQuery200ResponseQueryResult struct {
	value *BuildQuery200ResponseQueryResult
	isSet bool
}

func (v NullableBuildQuery200ResponseQueryResult) Get() *BuildQuery200ResponseQueryResult {
	return v.value
}

func (v *NullableBuildQuery200ResponseQueryResult) Set(val *BuildQuery200ResponseQueryResult) {
	v.value = val
	v.isSet = true
}

func (v NullableBuildQuery200ResponseQueryResult) IsSet() bool {
	return v.isSet
}

func (v *NullableBuildQuery200ResponseQueryResult) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBuildQuery200ResponseQueryResult(val *BuildQuery200ResponseQueryResult) *NullableBuildQuery200ResponseQueryResult {
	return &NullableBuildQuery200ResponseQueryResult{value: val, isSet: true}
}

func (v NullableBuildQuery200ResponseQueryResult) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBuildQuery200ResponseQueryResult) UnmarshalJSON(src []byte) error {
	v.isSet = true
