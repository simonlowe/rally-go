...
// checks if the ScheduleStateMutationScheduleState type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ScheduleStateMutationScheduleState{}

// ScheduleStateMutationScheduleState ScheduleState
type ScheduleStateMutationScheduleState struct {
	// Enabled
...
func NewScheduleStateMutationScheduleState() *ScheduleStateMutationScheduleState {
	this := ScheduleStateMutationScheduleState{}
	return &this
}
...
func (o ScheduleStateMutationScheduleState) ToMap() (map[string]interface{}, error) {
...
type NullableScheduleStateMutationScheduleState struct {
	value *ScheduleStateMutationScheduleState
	isSet bool
}

func (v NullableScheduleStateMutationScheduleState) Get() *ScheduleStateMutationScheduleState {
	return v.value
}

func (v *NullableScheduleStateMutationScheduleState) Set(val *ScheduleStateMutationScheduleState) {
	v.value = val
	v.isSet = true
}

func (v NullableScheduleStateMutationScheduleState) IsSet() bool {
	return v.isSet
}

func (v *NullableScheduleStateMutationScheduleState) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableScheduleStateMutationScheduleState(val *ScheduleStateMutationScheduleState) *NullableScheduleStateMutationScheduleState {
	return &NullableScheduleStateMutationScheduleState{value: val, isSet: true}
}

func (v NullableScheduleStateMutationScheduleState) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableScheduleStateMutationScheduleState) UnmarshalJSON(src []byte) error {
	v.isSet = true
