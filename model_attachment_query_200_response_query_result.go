...
// checks if the AttachmentQuery200ResponseQueryResult type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AttachmentQuery200ResponseQueryResult{}

// AttachmentQuery200ResponseQueryResult struct for AttachmentQuery200ResponseQueryResult
type AttachmentQuery200ResponseQueryResult struct {
...
func NewAttachmentQuery200ResponseQueryResult() *AttachmentQuery200ResponseQueryResult {
	this := AttachmentQuery200ResponseQueryResult{}
	return &this
}
...
func (o AttachmentQuery200ResponseQueryResult) MarshalJSON() ([]byte, error) {
...
func (o AttachmentQuery200ResponseQueryResult) ToMap() (map[string]interface{}, error) {
...
type NullableAttachmentQuery200ResponseQueryResult struct {
	value *AttachmentQuery200ResponseQueryResult
	isSet bool
}

func (v NullableAttachmentQuery200ResponseQueryResult) Get() *AttachmentQuery200ResponseQueryResult {
	return v.value
}

func (v *NullableAttachmentQuery200ResponseQueryResult) Set(val *AttachmentQuery200ResponseQueryResult) {
	v.value = val
	v.isSet = true
}

func (v NullableAttachmentQuery200ResponseQueryResult) IsSet() bool {
	return v.isSet
}

func (v *NullableAttachmentQuery200ResponseQueryResult) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAttachmentQuery200ResponseQueryResult(val *AttachmentQuery200ResponseQueryResult) *NullableAttachmentQuery200ResponseQueryResult {
	return &NullableAttachmentQuery200ResponseQueryResult{value: val, isSet: true}
}

func (v NullableAttachmentQuery200ResponseQueryResult) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAttachmentQuery200ResponseQueryResult) UnmarshalJSON(src []byte) error {
	v.isSet = true
