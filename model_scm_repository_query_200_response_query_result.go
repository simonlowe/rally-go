...
// checks if the SCMRepositoryQuery200ResponseQueryResult type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SCMRepositoryQuery200ResponseQueryResult{}

// SCMRepositoryQuery200ResponseQueryResult struct for SCMRepositoryQuery200ResponseQueryResult
type SCMRepositoryQuery200ResponseQueryResult struct {
	StartIndex *int64 `json:"StartIndex,omitempty"`
	PageSize *int64 `json:"PageSize,omitempty"`
	TotalResultCount *int64 `json:"TotalResultCount,omitempty"`
	Results []SCMRepository `json:"Results,omitempty"`
...
func NewSCMRepositoryQuery200ResponseQueryResult() *SCMRepositoryQuery200ResponseQueryResult {
	this := SCMRepositoryQuery200ResponseQueryResult{}
	return &this
}
...
// SetResults gets a reference to the given []SCMRepository and assigns it to the Results field.
...
func (o SCMRepositoryQuery200ResponseQueryResult) MarshalJSON() ([]byte, error) {
...
func (o SCMRepositoryQuery200ResponseQueryResult) ToMap() (map[string]interface{}, error) {
...
type NullableSCMRepositoryQuery200ResponseQueryResult struct {
	value *SCMRepositoryQuery200ResponseQueryResult
	isSet bool
}

func (v NullableSCMRepositoryQuery200ResponseQueryResult) Get() *SCMRepositoryQuery200ResponseQueryResult {
	return v.value
}

func (v *NullableSCMRepositoryQuery200ResponseQueryResult) Set(val *SCMRepositoryQuery200ResponseQueryResult) {
	v.value = val
	v.isSet = true
}

func (v NullableSCMRepositoryQuery200ResponseQueryResult) IsSet() bool {
	return v.isSet
}

func (v *NullableSCMRepositoryQuery200ResponseQueryResult) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSCMRepositoryQuery200ResponseQueryResult(val *SCMRepositoryQuery200ResponseQueryResult) *NullableSCMRepositoryQuery200ResponseQueryResult {
	return &NullableSCMRepositoryQuery200ResponseQueryResult{value: val, isSet: true}
}

func (v NullableSCMRepositoryQuery200ResponseQueryResult) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSCMRepositoryQuery200ResponseQueryResult) UnmarshalJSON(src []byte) error {
	v.isSet = true
