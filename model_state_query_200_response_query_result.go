...
// checks if the StateQuery200ResponseQueryResult type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &StateQuery200ResponseQueryResult{}

// StateQuery200ResponseQueryResult struct for StateQuery200ResponseQueryResult
type StateQuery200ResponseQueryResult struct {
	StartIndex *int64 `json:"StartIndex,omitempty"`
	PageSize *int64 `json:"PageSize,omitempty"`
	TotalResultCount *int64 `json:"TotalResultCount,omitempty"`
	Results []State `json:"Results,omitempty"`
...
func NewStateQuery200ResponseQueryResult() *StateQuery200ResponseQueryResult {
	this := StateQuery200ResponseQueryResult{}
	return &this
}
...
// SetResults gets a reference to the given []State and assigns it to the Results field.
...
func (o StateQuery200ResponseQueryResult) MarshalJSON() ([]byte, error) {
...
func (o StateQuery200ResponseQueryResult) ToMap() (map[string]interface{}, error) {
...
type NullableStateQuery200ResponseQueryResult struct {
	value *StateQuery200ResponseQueryResult
	isSet bool
}

func (v NullableStateQuery200ResponseQueryResult) Get() *StateQuery200ResponseQueryResult {
	return v.value
}

func (v *NullableStateQuery200ResponseQueryResult) Set(val *StateQuery200ResponseQueryResult) {
	v.value = val
	v.isSet = true
}

func (v NullableStateQuery200ResponseQueryResult) IsSet() bool {
	return v.isSet
}

func (v *NullableStateQuery200ResponseQueryResult) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableStateQuery200ResponseQueryResult(val *StateQuery200ResponseQueryResult) *NullableStateQuery200ResponseQueryResult {
	return &NullableStateQuery200ResponseQueryResult{value: val, isSet: true}
}

func (v NullableStateQuery200ResponseQueryResult) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableStateQuery200ResponseQueryResult) UnmarshalJSON(src []byte) error {
	v.isSet = true
