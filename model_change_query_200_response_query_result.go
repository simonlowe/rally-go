...
// checks if the ChangeQuery200ResponseQueryResult type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ChangeQuery200ResponseQueryResult{}

// ChangeQuery200ResponseQueryResult struct for ChangeQuery200ResponseQueryResult
type ChangeQuery200ResponseQueryResult struct {
...
func NewChangeQuery200ResponseQueryResult() *ChangeQuery200ResponseQueryResult {
	this := ChangeQuery200ResponseQueryResult{}
	return &this
}
...
// SetResults gets a reference to the given []Change and assigns it to the Results field.
...
func (o ChangeQuery200ResponseQueryResult) MarshalJSON() ([]byte, error) {
...
func (o ChangeQuery200ResponseQueryResult) ToMap() (map[string]interface{}, error) {
...
type NullableChangeQuery200ResponseQueryResult struct {
	value *ChangeQuery200ResponseQueryResult
	isSet bool
}

func (v NullableChangeQuery200ResponseQueryResult) Get() *ChangeQuery200ResponseQueryResult {
	return v.value
}

func (v *NullableChangeQuery200ResponseQueryResult) Set(val *ChangeQuery200ResponseQueryResult) {
	v.value = val
	v.isSet = true
}

func (v NullableChangeQuery200ResponseQueryResult) IsSet() bool {
	return v.isSet
}

func (v *NullableChangeQuery200ResponseQueryResult) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableChangeQuery200ResponseQueryResult(val *ChangeQuery200ResponseQueryResult) *NullableChangeQuery200ResponseQueryResult {
	return &NullableChangeQuery200ResponseQueryResult{value: val, isSet: true}
}

func (v NullableChangeQuery200ResponseQueryResult) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableChangeQuery200ResponseQueryResult) UnmarshalJSON(src []byte) error {
	v.isSet = true
