...
// checks if the IterationQuery200ResponseQueryResult type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IterationQuery200ResponseQueryResult{}

// IterationQuery200ResponseQueryResult struct for IterationQuery200ResponseQueryResult
type IterationQuery200ResponseQueryResult struct {
	StartIndex       *int64      `json:"StartIndex,omitempty"`
	PageSize         *int64      `json:"PageSize,omitempty"`
	TotalResultCount *int64      `json:"TotalResultCount,omitempty"`
	Results          []Iteration `json:"Results,omitempty"`
...
func NewIterationQuery200ResponseQueryResult() *IterationQuery200ResponseQueryResult {
	this := IterationQuery200ResponseQueryResult{}
	return &this
}
...
// SetResults gets a reference to the given []Iteration and assigns it to the Results field.
...
func (o IterationQuery200ResponseQueryResult) MarshalJSON() ([]byte, error) {
...
func (o IterationQuery200ResponseQueryResult) ToMap() (map[string]interface{}, error) {
...
type NullableIterationQuery200ResponseQueryResult struct {
	value *IterationQuery200ResponseQueryResult
	isSet bool
}

func (v NullableIterationQuery200ResponseQueryResult) Get() *IterationQuery200ResponseQueryResult {
	return v.value
}

func (v *NullableIterationQuery200ResponseQueryResult) Set(val *IterationQuery200ResponseQueryResult) {
	v.value = val
	v.isSet = true
}

func (v NullableIterationQuery200ResponseQueryResult) IsSet() bool {
	return v.isSet
}

func (v *NullableIterationQuery200ResponseQueryResult) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIterationQuery200ResponseQueryResult(val *IterationQuery200ResponseQueryResult) *NullableIterationQuery200ResponseQueryResult {
	return &NullableIterationQuery200ResponseQueryResult{value: val, isSet: true}
}

func (v NullableIterationQuery200ResponseQueryResult) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIterationQuery200ResponseQueryResult) UnmarshalJSON(src []byte) error {
	v.isSet = true
